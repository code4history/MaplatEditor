...
try {
  ...
  // kind: "tms" は m6-t1 が導入した必須チェックへの適応（validateBaseMapDocument は kind-required を持つ）
  const attrMissing = { ...fresh, kind: "tms", slug: "custom", title: { fr: "Titre" }, url: "https://x/{z}/{x}/{y}.png" };
