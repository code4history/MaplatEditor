...
# パッケージ版 (最新バージョン0.4.0)
* WIndows用 (64ビット): https://t.tilemap.jp/maplat/dist/MaplatEditor-0.4.0-win32.zip
* Mac用: https://t.tilemap.jp/maplat/dist/MaplatEditor-0.4.0-darwin.zip
* [リリースノート](https://github.com/code4history/MaplatEditor/releases/tag/v0.4.0)
