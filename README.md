...
# パッケージ版 (最新バージョン0.2.0)
* WIndows用 (64ビット): https://t.tilemap.jp/maplat/dist/MaplatEditor-0.2.0-win32.zip
* Mac用: https://t.tilemap.jp/maplat/dist/MaplatEditor-0.2.0-darwin.zip
* [リリースノート](https://github.com/code4nara/MaplatEditor/releases/tag/0.2.0)
