...
var imenv = pf == 'darwin' ? {
    'MAGICK_HOME' : imhome,
    'PATH': imbin + ':$PATH',
    'DYLD_LIBRARY_PATH' : imhome + '/lib'
} : {};
var imidfy = pf == 'darwin' ? imbin + '/identify' : pf == 'win32' ? imhome + '\\identify.exe' : 'identify';
var imconv = pf == 'darwin' ? imbin + '/convert' : pf == 'win32' ? imhome + '\\convert.exe' : 'convert';
