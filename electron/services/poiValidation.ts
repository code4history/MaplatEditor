...
export type ValidateResult =
  | { valid: true; features: PoiFeatureCollection['features'] }
  | { valid: false; errorCode: PoiSourceValidationErrorCode; message: string };

export function validatePointCoordinates(coords: unknown): coords is [number, number] {
...
export function validateFeatureCollection(data: unknown): ValidateResult {
