...
var mapedit = {
    ...
    save: function(mapObject, asCompiled) {
        ...
        if (asCompiled) {
            ...
            mapObject.compiled = {
                tins: tinObject.tins,
                strict_status: tinObject.strict_status,
                weight_buffer: tinObject.pointsWeightBuffer,
                vertices_params: tinObject.vertices_params,
                centroid: tinObject.centroid,
                kinks: tinObject.kinks
            };
            pretty = null;
        }
        var content = JSON.stringify(mapObject, null, pretty);
        var mapFile = mapFolder + path.sep + mapID + '.json';
        Promise.all([
