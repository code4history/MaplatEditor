...
var mapedit = {
        ...
        var loadData = function(data) {
            ...
            promise.then(function(json) {
                ...
                if (json.compiled) {
                    ...
                    promises.push(self.createTinFromGcpsAsync(json.gcps, [json.width, json.height],
                ...
                if (json.sub_maps) {
                    for (var i=0; i< json.sub_maps.length; i++) {
                        ...
                        if (sub_map.compiled) {
                            ...
                            promises.push(self.createTinFromGcpsAsync(sub_map.gcps, null,
    ...
    updateTin: function(gcps, index, bounds, strict, vertex) {
        var wh = index == 0 ? bounds : null;
        var bd = index != 0 ? bounds : null;
        this.createTinFromGcpsAsync(gcps, wh, bd, strict, vertex)
            .then(function(tin) {
                focused.webContents.send('updatedTin', [index, tin]);
            });
    },
    createTinFromGcpsAsync: function(gcps, wh, bounds, strict, vertex) {
